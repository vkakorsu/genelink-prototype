      ...
      <div className="two-col">
        ...
        <aside className="stack">
          <section className="card">
            ...
            {org.verification.status === "declined" && <Notice kind="halt">Declined: {org.verification.reason}</Notice>}
            {isAdminSeat && org.verification.status !== "verified" && org.verification.status !== "pending" && (
              <form action={requestVerification} className="stack" style={{ marginTop: 8 }}>
