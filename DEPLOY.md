...
The repository is public on GitHub under `vkakorsu/genelink-prototype`, with GitHub Actions (`.github/workflows/ci.yml`) running the configuration linter, the type check, the 90 tests and the production build on every push.
