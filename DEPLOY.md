...
The repository is public on GitHub under `vkakorsu/genelink-prototype`, with GitHub Actions (`.github/workflows/ci.yml`) running ESLint, the configuration linter, the type check, the 142 tests and the production build on every push.
